// api/handlers/inventory.js — getInventory, uploadInventoryPhoto, upsertInventory, adjustInventory, getInventoryLog
...
export async function handle_inventory(action, ctx) {
  ...
  const _owns = ['getInventory', 'uploadInventoryPhoto', 'upsertInventory', 'adjustInventory', 'getInventoryLog'];
