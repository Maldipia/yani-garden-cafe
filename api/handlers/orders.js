// api/handlers/orders.js — placeOrder, getOrders, updateOrderStatus, updateOrderTotals, restoreOrder...
...
export async function handle_orders(action, ctx) {
  ...
  const _owns = ['placeOrder', 'getOrders', 'updateOrderStatus', 'updateOrderTotals', 'restoreOrder', 'deleteOrder', 'toggleItemPrepared', 'setPaymentMethod', 'applyDiscount', 'getShiftSummary', 'editOrderItems', 'placePlatformOrder', 'requestReceipt', 'resendReceipt'];
